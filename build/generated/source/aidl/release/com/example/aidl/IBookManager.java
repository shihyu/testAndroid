 ...
 * Original file: E:\\WORKSPACE\\testAndroid\\src\\com\\example\\aidl\\IBookManager.aidl
 */
...
_arg0 = com.example.aidl.IOnNewBookListener.Stub.asInterface(data.readStrongBinder());
...
@Override public void registerListener(com.example.aidl.IOnNewBookListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregistenerListener(com.example.aidl.IOnNewBookListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void registerListener(com.example.aidl.IOnNewBookListener listener) throws android.os.RemoteException;
public void unregistenerListener(com.example.aidl.IOnNewBookListener listener) throws android.os.RemoteException;
}
